####
#BACK UP FOR SAVING BACKUP FILES FROM HERPSPECIES
...
#' 
#' 
herpSpeciesBackup <- function(url=NULL, dataList = NULL, taxonomicInfo = FALSE, fullHigher = FALSE, getLink = FALSE, backup_file = NULL, checkpoint = NULL)
{
